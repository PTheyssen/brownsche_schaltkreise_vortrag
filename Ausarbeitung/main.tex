...
% Titlepage setup
\title{On Non-polar Token-Pass Brownian Circuits} % Put yout topic name here
\subtitle{Proseminar Zellulare Automaten (SS 19)} % Put name of seminar and the current semester here. For example: "Seminar on interesting questions (SS 18)"
\author{Klaus Philipp Theyssen} % Put your name here
...
%\input{KITheader_english.tex} % english header
